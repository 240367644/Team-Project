    ...
    <body>
        ...
        <main>
            ...
            <div class="main-image">
                 ...
                 <div class="text">
                    <p><b>Make your room shine from day one</b></p>
                    <br>
            ...
            <div class="categories-header">
                <p class="text3">Discover by Category</p>
                <br>
                <p>Find everything you need for your student accommodation</p>
            </div>
            ...
            <section class="categories">
                ...
                <div class="category-container">
                    <div class="cards">
                        ...
                        <div class="desc">
                            <h2>Bedroom</h2>
                            <p>Essentials to make your room cozy such as bedding, pillows
                                and storage.
                            </p>
                        </div>
                    </div>
                    <div class="cards">
                        ...
                        <div class="desc">
                            <h2>Kitchen</h2>
                            <p>Make cooking easy using our kitchen essentials from utensils
                                to pots and pans.
                            </p>
                        </div>
                    </div>
                    <div class="cards">
                        ...
                        <div class="desc">
                            <h2>Bathroom</h2>
                            <p>Keep your bathroom fresh using our air freshners, detergent
                ...
                <div class="category-container">
                    <div class="cards">
                        ...
                        <div class="desc">
                            <h2>Desk & Study</h2>
                            <p>Stay motivated and organised with our study accessories such
                                as stationary and lamps.
                            </p>
                        </div>
                    </div>
                    <div class="cards">
                        ...
                        <div class="desc">
                            <h2>Decor & Lighting</h2>
                            <p>Upgrade your living space with aesthetic decorations and
                                lighting that fit your style.
                            </p>
                        </div>
                    </div>
                </div>
